...
<main>
  <div id="map"></div>
  <aside class="side">
    <div class="head"><h2 id="sidetitle">Rides</h2><div class="cnt" id="cnt"></div></div>
...
function select(id,fit){
  ...
  if(!id){ detail.hidden=true; list.hidden=false; document.getElementById('sidetitle').textContent='Rides'; drawList(); return; }
